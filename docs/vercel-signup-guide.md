...
| 챙길 것 | 어떻게 얻나 |
|---|---|
| 이폼사인에서 만든 **서식** | 웹폼 디자이너에서 만들고 발행합니다 |
...
## 4. 요금 — 먼저 무료로 해 보고, 계속 쓰기로 하면 유료로 바꿉니다

![Vercel 요금 화면](img/vercel-post-08-plan@2x.png)

**먼저 무료로 설치해 보세요.** 돈을 내지 않고 그대로 만들어 볼 수 있고, 잘 맞는지 보고 나서 정하면 됩니다.

**회사 업무로 계속 쓰기로 하면 유료 요금제(Pro)로 바꾸세요.** Vercel은 무료 요금제를 **개인 용도로만** 쓰도록 정해 두었습니다.
2026-09-15 기준 Pro는 **쓰는 사람 한 명에 한 달 20달러**입니다.

이 돈은 **Vercel에 직접 내는 것**이며, 이폼사인 방명록 이용료와는 별개입니다.

무료 요금제로는 **회사 공용으로 묶인 곳에 있는 파일을 연결할 수 없습니다.** 본인 계정에 두면 무료로도 그대로 됩니다.

바꾸는 곳은 Vercel 화면의 **Settings**(설정) 안 요금 항목입니다. 언제든 바꿀 수 있고, 지금 정하지 않아도 설치는 진행됩니다.
...
> 회사 업무로 매일 쓰기로 이미 정했다면 **Pro**를 고르세요.
